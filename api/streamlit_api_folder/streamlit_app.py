...
def show_terms_conditions():
    ...
    ### Contact & Support
    - **Email:** monikadhingra205@gmail.com
    - **Developer:** Monika, Btech CSE
    """)
...
def show_contact_us():
    ...
    with col1:
        ...
        **Monika**
        ...
        ### 📬 Contact Details
        - **Email:** monikadhingra205gmail.com
        - **Response Time:** 24-48 hours
    ...
    with col2:
        st.markdown("""
        ### 🔗 Professional Links
        - **LinkedIn:** [linkedin.com/in/monikadhingra](www.linkedin.com/in/monika-dhingra-742b95304)
        - **GitHub:** [github.com/Monika205](https://github.com/Monika205)
        - **Email:** monikadhingra205gmail.com
...
st.markdown(
    ...
    <div class="about-developer">
        ...
        <div class="developer-bio">
          Monika | Data Science Student bridging AI & healthcare
        </div>
    </div>
    """,
    unsafe_allow_html=True,
...
st.markdown(
    ...
    <div class="social-section">
        ...
        <div class="social-icons">
            <a href="https://https://github.com/Monika205" target="_blank" title="GitHub">
            ...
            <a href="mailto:monikadhingra205@gmail.com" title="Gmail">
            ...
            <a href="www.linkedin.com/in/monika-dhingra-742b95304" target="_blank" title="LinkedIn">
            ...
            <a href="https://huggingface.co/Monika" target="_blank" title="Hugging Face">
...
st.markdown(
    ...
    <div class="footer">
        <div class="footer-links">
            <a href="https://github.com/Monika205/chest-xray-pneumonia-detection-ai" target="_blank">Source Code & Model Details</a>
            <a href="mailto:monikadhingra205@gmail.com">Contact</a>
        </div>
